...
class VisualSupport extends React.Component {
  continue = e => {
    e.preventDefault();
    this.props.nextStep();
  }
  ...
  _addText = () => this._sketch.addText(this.state.text);
		...
		if(navigator.mediaDevices.getUserMedia || navigator.mediaDevices.webkitGetUserMedia) {
			const webcamPromise = navigator.mediaDevices.getUserMedia({
				...
				video: {
						...
						console.log("Could not start the web cam!");
						console.error(error);
					});
		}
		(function(console) {
    ...
    const {step} = this.props;
		...
		return (
            ...
            <AppBar title="Visual Support" position="static" style={styles.appBar}>
							<Toolbar>
								<Typography variant="h6" color="inherit" style={{ flexGrow: 1 }}>Visual Support</Typography>
								<IconButton
									color="primary"
				...
				<div className="row">
          <div className="col-xs-7 col-sm-7 col-md-9 col-lg-9" style={{ width: '100%' }}>
            <SketchField
              name="sketch"
            ...
            />
						<video className={style.video} autoPlay muted ref={this.videoRef} />
          </div>
          <div className="col-xs-5 col-sm-5 col-md-3 col-lg-3" style={{width: 'auto', display: 'block', position: 'absolute', top: '85px', right: '0'}}>
        ...
        <div>
          <div className="col-xs-7 col-sm-7 col-md-9 col-lg-9">
            ...
            <button className='next-button' onClick={this.continue}>Continue</button>
